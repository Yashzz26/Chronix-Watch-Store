...
const AdminLayout = ({ children }) => (
  <div className="d-flex min-vh-100 bg-obsidian-900 position-relative grain-overlay">
    <Sidebar />
    <main className="flex-grow-1 overflow-auto vh-100 scrollbar-hide position-relative" style={{ zIndex: 1 }}>
      {children}
    </main>
  </div>
);
