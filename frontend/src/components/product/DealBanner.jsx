...
export default function DealBanner({ product }) {
  ...
  return (
    <section className="position-relative overflow-hidden rounded-4 mb-5" style={{ background: 'linear-gradient(180deg, #0F0F0F 0%, #080808 100%)' }}>
      <div className="position-absolute top-0 start-0 w-100 h-100 opacity-10" style={{ backgroundImage: "url('https://www.transparenttextures.com/patterns/carbon-fibre.png')", pointerEvents: 'none' }} />
      ...
      <div className="position-relative z-1 flex-column flex-md-row d-flex align-items-center gap-5 p-4 p-md-5 p-lg-5">
        ...
        >
          ...
          />
          <div className="position-absolute top-0 end-0 bg-gold text-dark fw-bold p-3 rounded-circle d-flex flex-column align-items-center justify-content-center" style={{ width: 80, height: 80, boxShadow: '0 10px 30px rgba(212,175,55,0.3)' }}>
            <span className="text-uppercase tracking-tighter" style={{ fontSize: '0.6rem' }}>Save</span>
            <span className="fs-4 font-mono lh-1">33%</span>
          </div>
        </motion.div>
