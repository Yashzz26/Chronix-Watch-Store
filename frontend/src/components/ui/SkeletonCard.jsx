  ...
  return (
    <div className="chronix-card h-100 overflow-hidden d-flex flex-column opacity-50" style={{ minHeight: 400 }}>
      ...
      <div className="p-4 pt-4">
        ...
        <div className="bg-s3 rounded mb-3" style={{ height: 20, width: '75%', background: 'var(--s3)' }} />
        <div className="bg-s3 rounded mb-4" style={{ height: 16, width: 80, background: 'var(--s3)' }} />
        <div className="d-flex gap-2">
          <div className="bg-s3 rounded-3 flex-grow-1" style={{ height: 40, background: 'var(--s3)' }} />
          <div className="bg-s3 rounded-3" style={{ height: 40, width: 40, background: 'var(--s3)' }} />
        </div>
      </div>
      <style>{`
        @keyframes shimmer {
